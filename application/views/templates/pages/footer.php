            ...
            <div class="col">
              <form action="">
                <div class="input-group mx-auto">
                  <input type="text" class="form-control" placeholder="Your Email Address" name="search">
      ...
      <div class="container">
        <div class="row d-flex justify-content-center">
          <div class="social-media">
            <ul>
              <li><a href="https://www.facebook.com/evolveqatar" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/fb.png" alt="Facebook"></a></li>
              <li><a href="https://www.twitter.com/EvolveQatar" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/tw.png" alt="Twitter"></a></li>
              <li><a href="https://www.linkedin.com/company/evolve-qatar" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/li.png" alt="Linkedin"></a></li>
              <li><a href="https://www.instagram.com/evolvemindbodysoul" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/in.png" alt="Instagram"></a></li>
              <li><a href="https://www.youtube.com/channel/UCcnwggWU7Km7sO2s9Nh0-GQ" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/yt.png" alt="Youtube"></a></li>
              <li><a href="https://www.pinterest.com/evolveqatar/pins" target="_blank" class="hvr-float-shadow"><img src="<?php echo base_url('assets'); ?>/img/sm/pi.png" alt=""></a></li>
            </ul>
          </div>      
          <!-- <div class="col">
            <span class="title">Services</span>
            <ul>
              <li><a href="fitness-classes.html">Fitness Classes</a>
                <ul class="block">
                  <li><a href="#">Yoga</a></li>
            ...
            <ul>                        
              <li><a href="#">Holistic Wellness</a>
                <ul>
                  <li><a href="#">Access Bars</a></li>
                  <li><a href="#">Theta Healing</a></li>
                  <li><a href="#">Cosmic Massage</a></li>
          ...
          <div class="col">
            ...
            <ul class="text-center">
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/battitude.png" alt="B/Attitude Doha" /></a></li>
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/thewestin.png" alt="The Westin Doha" /></a></li>
            </ul>
            <ul class="text-center">
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/divalounge.png" alt="Diva Lounge" /></a></li>
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/airadaspa.png" alt="Airada Spa" /></a></li>
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/fourseasons.png" alt="Four Seasons" /></a></li>
            </ul>
            <ul class="text-center">
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/dynamik.png" alt="Dynamik at Pearl" /></a></li>
              <li class="img-icon"><a href="#" target="_blank"><img src="<?php echo base_url('assets'); ?>/img/loc/warwick.png" alt="Warwick" /></a></li>
            </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="col text-left">
              <p>&copy; 2018 EVOLVE MIND | BODY | SOUL . All Rights Reserved</p>
            </div>
    ...
    <?php
      ...
      // echo isset($var) =="personaltraining" ? $http.'img/bg/bg-2.jpg' : 'Error! - Please check the section part'; //TO CHECK

      switch ($var) {
        case 'ourpersonalisedtraining':
          $img = base_url('assets').'/img/bg/bg-2.jpg';
          break;
        case 'fitnessclasses':
          $img = base_url('assets').'/img/bg/bg-1.jpg';
          break;
        case 'swimming':
          $img = base_url('assets').'/img/bg/bg-3.jpg';
          break;
        case 'nutrition':
          $img = base_url('assets').'/img/bg/bg-4.jpg';
          break;
        case 'biomechanics':
          $img = base_url('assets').'/img/bg/bg-7.jpg';
          break;
        case 'accessbar':
          $img = base_url('assets').'/img/bg-9.jpg';
          break;
        case 'thaimassage':
          $img = base_url('assets').'/img/bg-16.jpg';
          break;
        case 'ayurveda':
          $img = base_url('assets').'/img/bg-14.jpg';
          break;
        case 'pranichealing':
          $img = base_url('assets').'/img/bg-15.jpg';
          break;
        case 'thetahealing':
          $img = base_url('assets').'/img/bg-8.jpg';
          break;
        case 'soundtherapy':
          $img = base_url('assets').'/img/bg-10.jpg';
          break;
        case 'cosmicmassage':
          $img = base_url('assets').'/img/bg-11.jpg';
          break;
        case 'corporateservices':
          $img = base_url('assets').'/img/bg-12.jpg';
          break;
        case 'company':
          $img = base_url('assets').'/img/bg/bg-13.jpg';
          break;
        case 'ourteam':
          $img = base_url('assets').'/img/bg/bg-6.jpg';
          break;
        case 'events':
          $img = base_url('assets').'/img/bg/bg-14.jpg';
          break;
        case 'timetable':
          $img = base_url('assets').'/img/bg/bg-5.jpg';
          break;
        default:
    ...
    ?>
      <script>
        $('.parallax-blank').parallax({imageSrc: ''});
        $('.parallax-green').parallax({imageSrc: ''});
        $('.parallax-window1').parallax({imageSrc: '<?php echo $img; ?>'});
      </script>
